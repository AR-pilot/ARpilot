(function () {
    ...
    class ARpilot {
        ...
        initUI() {
            ...
            stateSupplies.style = "width: 100%;display: flex;align-items: center;gap: 10px;justify-content: space-between;padding: 10px;box-sizing: border-box;";

            const suppliesEnabled = document.createElement("div");
            suppliesEnabled.style = `width: 100%; display: flex; justify-content: flex-end; gap: 5px; align-items: center;`;

            const suppliesLabel = document.createElement("label");
            suppliesLabel.innerText = "Supplies";
            suppliesLabel.style.color = "#fff";
            suppliesLabel.style.fontSize = "12px";

            const suppliesStatus = document.createElement("div");
            suppliesStatus.id = "supplies-status-icon";
            suppliesStatus.style.width = "12px";
            suppliesStatus.style.height = "12px";
            suppliesStatus.style.borderRadius = "50%";
            suppliesStatus.style.backgroundColor = "rgba(255, 255, 255, 0.3)";
            ...
            contentContainer.style = `height: calc(100% - ${this.utils.inBattle ? 240 : 180}px); padding: 10px; color: ${colors.lighttext}; font-size: 14px; overflow-y: auto; background: transparent; scrollbar-width: thin; scrollbar-color: rgba(255, 255, 255, 0.3) transparent;`;
        ...
        updateSuppliesSuperState() {
            ...
            if (this.settings.settings.suppliesClickEnabled) {
                el.style.backgroundColor = "rgb(118, 255, 51)";
                el.style.boxShadow = "0px 0px 6px rgba(118, 255, 51, 0.8)";
            } else {
        ...
        createSettingsTab(content) {
            ...
            const createBindSection = (label, bindName) => {
                ...
                sectionDiv.style = "display: flex; align-items: center; gap: 10px; flex-direction: column; padding: 10px; border: 1px dashed rgba(255, 255, 255, 0.1); border-radius: 5px;";
                ...
                keyDisplay.style = "font-weight: bold; color: rgb(163 163 163); font-family: 'BaseFontRegular';";
            ...
            if (this.settings.settings.developerMode) {
                ...
                Object.keys(allSupplies).forEach(supply => {
                    ...
                    supplyDiv.style = "display: flex; flex-direction: column; align-items: center; padding: 10px; gap: 10px; border-radius: 5px; border: 1px dashed rgba(255, 255, 255, 0.1);";
